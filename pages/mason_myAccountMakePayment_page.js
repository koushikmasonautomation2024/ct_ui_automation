...
exports.MyAccountMakePaymentPage = class MyAccountMakePaymentPage{
    constructor(page){
        ...
        this.newCCRadioButton=page.locator('div').filter({ hasText: new RegExp(myaccountpage_locator.makepayment_newcc_radiobutton) });
        this.savedCCRadioButton=page.locator('div').filter({ hasText: new RegExp(myaccountpage_locator.makepayment_savedcc_radiobuttion) });
