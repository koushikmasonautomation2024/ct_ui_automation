...
const items_in_cart = "in Your Order";
const item_in_cart="in Your Order";
...
exports.GuestCheckOutPage = class GuestCheckOutPage {
  ...
  async validateItemsInCartSection() {
    ...
    //const button = await this.page.waitForSelector('button[id="radix-:rsb:"]', { visible: true });
  ...
  async validateTwoPlaceOrderButtons(){
    await (this.page.getByRole('button', { name: 'Place Order' }).first()).waitFor({stete:"visible"});
